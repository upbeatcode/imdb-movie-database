...
const ChartModal = ({
  ...
  const handlePrevChart = () => {
    const currentIndex = chartTypes.findIndex(
      (chart) => chart.key === currentChart
    );
    const prevIndex =
      currentIndex > 0 ? currentIndex - 1 : chartTypes.length - 1;
  ...
  const handleNextChart = () => {
    ...
    const nextIndex =
      currentIndex < chartTypes.length - 1 ? currentIndex + 1 : 0;
    ...
    <div className="chart-modal-overlay">
      <div className="chart-modal-content">
        ...
        <div className="chart-modal-header">
          <h3>{chartTypes.find((c) => c.key === currentChart)?.label}</h3>
